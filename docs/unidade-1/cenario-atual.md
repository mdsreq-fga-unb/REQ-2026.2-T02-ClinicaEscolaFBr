...
| Estagiários de Psicologia                   | Realizam os atendimentos sob supervisão; principais usuários do prontuário e da agenda                                 | Menos tempo em tarefas administrativas e mais tempo de prática clínica                                   | Interface simples para executar as tarefas exigidas pelo estágio                                                |      Médio       |
