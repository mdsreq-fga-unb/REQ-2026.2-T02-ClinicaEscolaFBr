...
- **Priorização MoSCoW:** será utilizada para classificar as features conforme sua importância para o produto em *Must Have*, *Should Have*, *Could Have* e *Won’t Have this time*, apoiando a definição do escopo e das funcionalidades prioritárias para o MVP.
